    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
					<!-- Top Bar Start -->						
						<?php $title ="¿Quieres conocer ANE? Registrate.";
															...
															<div class="card-body">
															   ...
															   <!-- <h4 class="mt-0 header-title">Textual inputs</h4>-->
																...
																<div class="form-group row">
																	<label class="col-sm-2 col-form-label"><span class="red">*</span> ¿Cuál es tu giro?</label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label class="col-sm-2 col-form-label"><span class="red">*</span> ¿Cuál es tu especialidad?</label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label for="example-text-input" class="col-sm-2 col-form-label"><span class="red">*</span>  Cuantos años tienes en el negocio  </label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																<label class="col-sm-2 col-form-label"><span class="red">*</span>Cuando nos visitas</label>
																<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label for="example-text-input" class="col-sm-2 col-form-label"><span class="red">*</span>Describe tus servicios </label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label for="example-text-input" class="col-sm-2 col-form-label"><span class="red">*</span> Empresa </label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label for="example-text-input" class="col-sm-2 col-form-label"><span class="red">*</span> Telefono/Whatsapp  </label>
																	<div class="col-sm-5">
																...
																<div class="form-group row">
																	<label for="example-text-input" class="col-sm-2 col-form-label"><span class="red">*</span> Correo Electronico  </label>
																	<div class="col-sm-5">
																		...
																		<input class="form-control" type="hidden" name="accion" value="guardaVisitas2">
