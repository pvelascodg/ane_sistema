...
<div class="topbar-left">
    <div class="">
        ...
        <a href="index.php" class="logo"><img src="public/assets/images/amdeb.png" height="36" alt="logo"></a>
    </div>
</div>
...
<div class="sidebar-inner slimscrollleft">
    <div id="sidebar-menu">
        <ul>
            <li class="menu-title">Bienvenido Admin</li>
            ...
            <li>
			 ...
			 <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-clipboard-outline"></i><span> Formularios  <span class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                <ul class="list-unstyled">
                    <li><a href="form-elements.php">Formulario Vis a Vis</a></li>
                    <li><a href="referencias.php">Formulario Referencias</a></li>
                    <li><a href="negocios.php">Formulario Negocios Concretados</a></li>
					<li><a href="invitados.php">formulario de Invitados</a></li>
                </ul>
            </li>
			...
			<li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="lista-vis.php">Formulario Vis a Vis</a></li>
                    <li><a href="lista-referencias.php">Formulario Referencias</a></li>
                    <li><a href="lista-negocios.php">Formulario Negocios Concretados</a></li>
					<li><a href="lista-invitados.php">formulario de Invitados</a></li>
                </ul>
            </li>
			<?php } ?>
           <!-- <li>
