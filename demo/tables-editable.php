...
<?php include 'layouts/headerStyle.php'; ?>
    ...
    <body class="fixed-left">
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Table Editable</h3>
                                </li>
                            </ul>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="mainTable" class="table table-striped m-b-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><strong>1290</strong></th>
                                                    <th><strong>1420</strong></th>
        ...
        <!-- Table editable -->
        <script src="public/plugins/tiny-editable/mindmup-editabletable.js"></script>
        <script src="public/plugins/tiny-editable/numeric-input-example.js"></script>
